...
public class routes {
  ...
  public static final controllers.ReverseOrderedProductController OrderedProductController = new controllers.ReverseOrderedProductController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseOrderedProductController OrderedProductController = new controllers.javascript.ReverseOrderedProductController(RoutesPrefix.byNamePrefix());
  }
