...
*/
  ...
  def addProduct = Action.async { implicit request =>
    ...
    productForm.bindFromRequest.fold(
      ...
      product => {
        productsRepo.create(product.name, product.price, product.description, product.category).map { _ =>
...
//  def order() = play.mvc.Results.TODO
}
 ...
 */
case class CreateProductForm(name: String, price: Int, description: String, category: Int)
